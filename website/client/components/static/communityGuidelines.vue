    ...
    .col-md-12
      ...
      .clearfix
        ...
        ul.pull-left.list-unstyled
          li
            strong=env.t('commGuideAKA', {habitName: 'Beffymaroo', realName: 'Beth'})
          li
            strong=env.t('commGuideAKA', {habitName: 'Viirus', realName: 'Phillip'})
          li
            strong=env.t('commGuideAKA', {habitName: 'redphoenix', realName: 'Vicky'})
              |  (
              =env.t('commGuideOnTrello', {trelloName: 'caffeinatedvee'})
              | ,&nbsp;
              =env.t('commGuideOnGitHub', {gitHubName: 'veeeeeee'})
              | )
          li
            strong=env.t('commGuideAKA', {habitName:'Lemoness', realName: 'Leslie'})
              |  (
              =env.t('commGuideOnTrello', {trelloName: 'lemonesstree'})
              | )
          li
            strong=env.t('commGuideAKA', {habitName: 'SabreCat', realName: 'Sabe'})
          li
            strong=env.t('commGuideAKA', {habitName: 'paglias', realName: 'Matteo'})
          li
            strong=env.t('commGuideAKA', {habitName: 'TheHollidayInn', realName: 'Keith'})
      br
      ...
      .clearfix
        ...
        ul.pull-left.list-unstyled
          ...
          li
            strong Blade (
              =env.t('commGuideOnGitHub', {gitHubName: 'crookedneighbor'})
              |)
          li
      ...
      .clearfix
        ...
        ul
          ...
          li!=env.t('commGuideList02J')
          li!=env.t('commGuideList02K', { hrefCommunityManagerEmail : '<a href="mailto:' + env.EMAILS.COMMUNITY_MANAGER_EMAIL + '">' + env.EMAILS.COMMUNITY_MANAGER_EMAIL +'</a>' })
        br
        p!=env.t('commGuidePara019')
        br
        p!=env.t('commGuidePara020')
        br
        p!=env.t('commGuidePara020A', { hrefCommunityManagerEmail : '<a href="mailto:' + env.EMAILS.COMMUNITY_MANAGER_EMAIL + '">' + env.EMAILS.COMMUNITY_MANAGER_EMAIL + '</a>' })
        br
      ...
      .clearfix
        ...
        ul
          ...
          li!=env.t('commGuideList04DRev', { hrefCommunityManagerEmail : '<a href="mailto:' + env.EMAILS.COMMUNITY_MANAGER_EMAIL + '">' + env.EMAILS.COMMUNITY_MANAGER_EMAIL + '</a>' })
          li=env.t('commGuideList04E')
          li!=env.t('commGuideList04F')
          li=env.t('commGuideList04G')
          li=env.t('commGuideList04H')
        br
        p=env.t('commGuidePara049')
        ul.peopleList
          li LadyAlys (Alys)
          li Sonnet73
          li Taldin
        br
        p=env.t('commGuidePara049A')
        ul.peopleList
          li Beffymaroo
          li Cantras
      ...
      .clearfix
        ...
        p=env.t('commGuidePara060A')
        p!=env.t('commGuidePara060B', { hrefCommunityManagerEmail : '<a href="mailto:' + env.EMAILS.COMMUNITY_MANAGER_EMAIL + '">' + env.EMAILS.COMMUNITY_MANAGER_EMAIL + '</a>' })
