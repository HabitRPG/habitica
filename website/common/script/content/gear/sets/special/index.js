...
const CURRENT_SEASON = findKey(EVENTS, event => {
...
const armor = {
  ...
  yeti: {
    ...
    con: 9,
    value: 90,
    canBuy: () => CURRENT_SEASON.includes('winter'),
  },
  ski: {
    event: EVENTS.winter,
    specialClass: 'rogue',
  ...
  springRogue: {
    ...
    canBuy: () => CURRENT_SEASON.includes('spring'),
  },
  springWarrior: {
    set: 'mightyBunnySet',
    canBuy: () => CURRENT_SEASON.includes('spring'),
  ...
  summerRogue: {
    ...
    canBuy: () => CURRENT_SEASON.includes('summer'),
  },
  summerWarrior: {
  ...
  fallRogue: {
    ...
    canBuy: () => CURRENT_SEASON.includes('fall'),
  },
  fallWarrior: {
