...
module.exports = function staticMiddleware (expressApp) {
  ...
  expressApp.use('/static/sprites', express.static(`${STATIC_DIR}/sprites`, { maxAge: MAX_AGE }));
  // so we have access to the gif sprites
  expressApp.use(express.static(`${STATIC_DIR}/sprites/gif/backer_only`, { maxAge: MAX_AGE }));
