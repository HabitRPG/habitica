...
let bannedWordsReligious = [
  'TEST_PLACEHOLDER_BANNED_WORD_RELIGIOUS',
];
let bannedWordsSwears = [
  'TEST_PLACEHOLDER_BANNED_WORD_SWEARWORD',
];
let bannedWordsAddictive = [
  'TEST_PLACEHOLDER_BANNED_WORD_ADDICTIVE',
];

module.exports = {bannedWordsReligious, bannedWordsSwears, bannedWordsAddictive};
