...
const RESPONSE_NAME = 'content_cache';
...
api.getContent = {
  ...
  async handler (req, res) {
    ...
    let content = await getCachedResponse(RESPONSE_NAME, language);

    if (!content) { // generate the response
    ...
    saveResponseToDisk(RESPONSE_NAME, language, content);
  },
};
