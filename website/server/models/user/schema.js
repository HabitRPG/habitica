...
export default new Schema(
  {
          ...
          validate: [
            ...
            },
            {
              validator (email) {
                ...
                return RESTRICTED_EMAIL_DOMAINS.every(
                  domain => !lowercaseEmail.endsWith(`@${domain}`),
                );
              },
              message: shared.i18n.t('invalidEmailDomain', {
                domains: RESTRICTED_EMAIL_DOMAINS.join(', '),
              }),
            },
          ],
        },
    ...
    challenges: [
      {
        $type: String,
        ref: 'Challenge',
        validate: [v => validator.isUUID(v), 'Invalid uuid for user challenges.'],
      },
    ],
    ...
    guilds: [
      {
        $type: String,
        ref: 'Group',
        validate: [v => validator.isUUID(v), 'Invalid uuid for user guild.'],
      },
    ],
    ...
    party: {
      _id: {
        $type: String,
        validate: [v => validator.isUUID(v), 'Invalid uuid for user party.'],
        ref: 'Group',
      },
    ...
    preferences: {
      ...
      sound: {
        $type: String,
        default: 'rosstavoTheme',
        enum: ['off', ...shared.content.audioThemes],
      },
      ...
      improvementCategories: {
        ...
        validate: categories => {
          ...
          const isValidCategory = categories.every(
            category => validCategories.indexOf(category) !== -1,
          );
