...
gulp.task('build:dev', ['browserify', 'prepare:staticNewStuff', 'bootstrap'], (done) => {
...
gulp.task('build:prod', ['browserify', 'build:server', 'prepare:staticNewStuff', 'bootstrap'], (done) => {
  runSequence(
    'grunt-build:prod',
    'apidoc',
    done
