...
api.userDefaults =
  ...
  todos: [
    ...
    {type: 'todo', text: t('defaultTodo5Text'), notes: t('defaultTodoBlank'), checklist: [{completed: false, text: t('defaultTodo5Checklist1') }, {completed: false, text: t('defaultTodo5Checklist2')}, {completed: false, text: t('defaultTodo5Checklist3')}], completed: false, attribute: 'per' }
    {type: 'todo', text: t('defaultTodo6Text'), notes: t('defaultTodoBlank'), checklist: [{completed: false, text: t('defaultTodo6Checklist1') }, {completed: false, text: t('defaultTodo6Checklist2')}, {completed: false, text: t('defaultTodo6Checklist3')}], completed: false, attribute: 'per' }
    {type: 'todo', text: t('defaultTodo7Text'), notes: t('defaultTodoBlank'), completed: false, attribute: 'per' }
