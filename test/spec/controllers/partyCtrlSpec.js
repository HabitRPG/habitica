...
describe("Party Controller", function() {
  var scope, ctrl, user, User, questsService, groups, achievement, rootScope, $controller;
  ...
  beforeEach(function() {
    ...
    inject(function(_$rootScope_, _$controller_, Groups, Quests, Achievement){
    ...
    context('party has 4 members', function() {
      ...
      context('user has neither "Party Up" nor "Party On" achievements', function() {
        it('awards "Party Up" and "Party On" achievements', function() {
          ...
          expect(achievement.displayAchievement).to.be.calledTwice;
          expect(achievement.displayAchievement).to.be.calledWith('partyUp');
          expect(achievement.displayAchievement).to.be.calledWith('partyOn');
        });
      });
