...
context('banned word', () => {
  ...
  it.only('checks error message has the banned words used', async () => {
    var randIndex = Math.floor(Math.random() * (bannedWords.length + 1));
    let testBannedWords = bannedWords.slice(randIndex, randIndex + 2);
