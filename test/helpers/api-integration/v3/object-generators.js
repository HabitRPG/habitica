...
// { 'items.eggs.Wolf': 10 }
// This function automatically resets the user
// (removes tasks generated by regestration).
// To prevent this behavior, set keepDefaultTasks to true
export async function generateUser (update = {}, keepDefaultTasks = false) {
