...
items = module.exports.items =
  weapon: [
    ...
    {index: 7, text: "Dark Matter Sword", classes:'weapon_7', notes"'Increases experience gain by 25%', strength: 25, value:200}
  ]
  armor: [
    ...
    {index: 6, text: "Dark Matter Armor", classes: 'armor_6', notes:'Decreases HP loss by 15%.', defense: 15, value: 200}
  ]
  head: [
    ...
    {index: 6, text: "Dark Matter Helm", classes: 'head_6', notes:'Decreases HP loss by 9%', defense: 9, value: 150}
  ]
  shield: [
    ...
    {index: 6, text: "Dark Matter Shield", classes: 'shield_6', notes:'Decreases HP loss by 12%', defense: 12, value: 175}
  ]
