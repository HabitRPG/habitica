...
(function() {
  var HP, XP, hatchingPotions, helpers, items, moment, obj, pets, randomDrop, updateStats, _, _ref, _ref1,
  ...
  _ref = require('../index'), helpers = _ref.helpers, items = _ref.items;

  _ref1 = items.items, pets = _ref1.pets, hatchingPotions = _ref1.hatchingPotions;
  ...
  */
  ...
  obj.gpModifier = function(value, modifier, priority, streak, user) {
    var afterStreak, streakBonus, val, _ref2;
    ...
    if (streak && user) {
      ...
      if (val > 0) {
        ((_ref2 = user._tmp) != null ? _ref2 : user._tmp = {}).streakBonus = afterStreak - val;
      }
      return afterStreak;
    } else {
      return val;
  ...
  */
  ...
  randomDrop = function(user, delta, priority, streak, options) {
    var acceptableDrops, chanceMultiplier, drop, paths, rarity, reachedDropLimit, _base, _base1, _base2, _ref2, _ref3, _ref4, _ref5, _ref6;
    ...
    paths = options.paths || {};
    if ((_ref2 = (_base = user.items).lastDrop) == null) {
      _base.lastDrop = {
    ...
    if (((_ref3 = user.flags) != null ? _ref3.dropsEnabled : void 0) && Math.random() < (.05 * chanceMultiplier)) {
      rarity = Math.random();
      if (rarity > .5) {
        drop = helpers.randomVal(pets);
        ((_ref4 = (_base1 = user.items).eggs) != null ? _ref4 : _base1.eggs = []).push(drop);
        ...
        acceptableDrops = hatchingPotions.filter(function(hatchingPotion) {
          ...
          return _ref5 = hatchingPotion.name, __indexOf.call(acceptableDrops, _ref5) >= 0;
        });
        drop = helpers.randomVal(acceptableDrops);
        ((_ref5 = (_base2 = user.items).hatchingPotions) != null ? _ref5 : _base2.hatchingPotions = []).push(drop.name);
        paths['items.hatchingPotions'] = true;
        drop.type = 'HatchingPotion';
        drop.dialog = "You've found a " + drop.text + " Hatching Potion! " + drop.notes;
      }
      ((_ref6 = user._tmp) != null ? _ref6 : user._tmp = {}).drop = drop;
  ...
  obj.score = function(user, task, direction, options) {
    var addPoints, calculateDelta, cron, delta, exp, gp, hp, lvl, num, paths, priority, streak, subtractPoints, times, type, value, _ref2, _ref3, _ref4;

    if (options == null) {
      options = {};
    }
    _ref2 = user.stats, gp = _ref2.gp, hp = _ref2.hp, exp = _ref2.exp, lvl = _ref2.lvl;
  ...
  */
  ...
  obj.cron = function(user, options) {
    var daysMissed, expTally, lvl, now, paths, todoTally, _base, _base1, _ref2, _ref3, _ref4, _ref5, _ref6;

    if (options == null) {
      options = {};
    }
    _ref2 = [options.paths || {}, +options.now || +(new Date)], paths = _ref2[0], now = _ref2[1];
    if ((user.lastCron == null) || user.lastCron === 'new' || moment(user.lastCron).isAfter(now)) {
      user.lastCron = now;
      paths['lastCron'] = true;
      return;
    }
    daysMissed = helpers.daysBetween(user.lastCron, now, (_ref3 = user.preferences) != null ? _ref3.dayStart : void 0);
    if (!(daysMissed > 0)) {
      return;
    }
    user.lastCron = now;
    ...
    user.todos.concat(user.dailys).forEach(function(task) {
      var absVal, completed, id, repeat, scheduleMisses, type, _ref4;
        ...
        if ((type === 'daily') && repeat) {
          ...
          _.times(daysMissed, function(n) {
            ...
            if (helpers.shouldDo(thatDay, repeat, {
              dayStart: (_ref4 = obj.preferences) != null ? _ref4.dayStart : void 0
            })) {
    ...
    ((_ref4 = (_base = ((_ref5 = user.history) != null ? _ref5 : user.history = {})).todos) != null ? _ref4 : _base.todos = []).push({
      date: now,
      value: todoTally
    });
    ...
    ((_ref6 = (_base1 = user.history).exp) != null ? _ref6 : _base1.exp = []).push({
      date: now,
      value: expTally
    });
    paths["history"] = true;
...
},{"../index":6,"lodash":5,"moment":7}],8:[function(require,module,exports){
  ...
  module.exports = {
    ...
    */
    ...
    totalStr: function(level, weapon) {
      ...
      str = (level - 1) / 2;
      return totalStr = str + items.items.weapon[weapon].strength;
    },
    ...
    totalDef: function(level, armor, helm, shield) {
      ...
      def = (level - 1) / 2;
      return totalDef = def + items.items.armor[armor].defense + items.items.head[helm].defense + items.items.shield[shield].defense;
    },
    itemText: function(type, item) {
      if (item == null) {
        item = 0;
      }
      return items.items[type][parseInt(item)].text;
    },
    itemStat: function(type, item) {
      ...
      if (type === 'weapon') {
        return items.items[type][parseInt(item)].strength;
      } else {
        return items.items[type][parseInt(item)].defense;
      }
    }
  };
...
},{"../index":6,"lodash":5,"moment":7,"relative-date":9,"__browserify_process":8}],5:[function(require,module,exports){
(function(global){/**
 * @license
...
},{"./script/items.coffee":3,"./script/helpers.coffee":4,"./script/algos.coffee":2}],9:[function(require,module,exports){
