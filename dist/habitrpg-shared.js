...
},{"./script/index.coffee":5,"lodash":6,"moment":7}],2:[function(require,module,exports){
  ...
  warrior: {
    ...
    defensiveStance: {
      ...
      cast: function(user, target) {
        ...
        return user.stats.buffs.con += Math.ceil(diminishingReturns(bonus, 20, 200));
      }
    },
    valorousPresence: {
    ...
    intimidate: {
      ...
      cast: function(user, target) {
        return _.each(target, function(member) {
          ...
          return member.stats.buffs.con += Math.ceil(diminishingReturns(bonus, 12, 200));
        });
      }
    }
  },
    ...
    protectAura: {
      ...
      cast: function(user, target) {
        return _.each(target, function(member) {
          ...
          return member.stats.buffs.con += Math.ceil(diminishingReturns(bonus, 100, 200));
        });
      }
    },
    heallAll: {
...
},{"./i18n.coffee":4,"lodash":6,"moment":7}],4:[function(require,module,exports){
var _;
...
},{"./content.coffee":3,"./i18n.coffee":4,"_process":2,"lodash":6,"moment":7}],6:[function(require,module,exports){
(function (global){
/**
 * @license
