...
* [Setting up Habitica Locally](http://habitica.fandom.com/wiki/Setting_up_Habitica_Locally) - How to set up a local installation of Habitica for development and testing on various platforms.
